        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    Correo:<asp:TextBox ID="txtcorreo" runat="server" ForeColor="Black" TextMode="Email"></asp:TextBox>
                    Contacto:<asp:TextBox ID="txtcontacto" runat="server" ForeColor="Black"></asp:TextBox><br>
                    Estado:
                      <asp:DropDownList ID="dptestado" runat="server" AutoPostBack="False" CssClass="alert-dark">
                          <asp:ListItem Value="1">Activo</asp:ListItem>
                          <asp:ListItem Value="2">Inactivo</asp:ListItem>
                      </asp:DropDownList>
                    <br>
