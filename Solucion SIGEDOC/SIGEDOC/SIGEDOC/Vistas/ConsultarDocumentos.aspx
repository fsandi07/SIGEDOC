        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <div class="collapse show" id="collapseCardExample">
                    <asp:GridView ID="GridDocumento" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDatadocreados" OnRowDataBound="GridDocumento_RowDataBound" OnSelectedIndexChanged="GridDocumento_SelectedIndexChanged" Width="1026px" HorizontalAlign="Center" DataKeyNames="numtotaldocu" OnRowCommand="GridDocumento_RowCommand" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2" ForeColor="Black">
                        <Columns>
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <div class="collapse show" id="collapseCardExample2">
                    <asp:GridView ID="GridDocSubido" runat="server" Width="852px" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="numTotalSub" DataSourceID="SqlDataDocSubido" OnSelectedIndexChanged="GridDocSubido_SelectedIndexChanged" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" HorizontalAlign="Center" RowStyle-HorizontalAlign="Center" RowStyle-VerticalAlign="Middle" EditRowStyle-HorizontalAlign="Center" EditRowStyle-VerticalAlign="Middle" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataRowStyle-VerticalAlign="Middle" CellSpacing="2" OnRowCommand="GridDocSubido_RowCommand" ForeColor="Black">
                        <Columns>
                            <asp:CommandField HeaderText="Editar" SelectText="&lt;i class='fas fa-edit'&gt;&lt;/i&gt;" ShowSelectButton="True" />
                        ...
                        <FooterStyle BackColor="#CCCCCC" />
                        <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" BorderStyle="Inset" HorizontalAlign="Center" VerticalAlign="Middle" />
                        <PagerStyle ForeColor="Black" HorizontalAlign="Left" BackColor="#CCCCCC" />
