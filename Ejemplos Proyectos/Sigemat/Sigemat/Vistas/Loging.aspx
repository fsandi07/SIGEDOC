<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Loging.aspx.cs" Inherits="Sigemat.Vistas.Loging" %>
...
<head runat="server">
  ...
  <title>Login-Adminsitrador</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">BIENVENIDO SIGEMAT ESCOLAR</h1>
                  </div>
                    <form id="form1" runat="server">
                      <div class="form-group">
                       ...
                       <asp:Button class="btn btn-primary btn-user btn-block"  ID="BtnIngreso" runat="server" Text="Ingresar" OnClick="BtnIngreso_Click" />
                    </form>
                  <hr>
                  <div class="text-center">
